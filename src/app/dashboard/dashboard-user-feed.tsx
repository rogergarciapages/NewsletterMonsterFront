          ...
          <div className="grid gap-4">
            ...
            <Card>
              <CardHeader className="flex flex-col items-start gap-2 sm:flex-row sm:items-center">
                ...
                <div className="grid gap-2 text-left sm:ml-auto">
                  <div className="text-sm text-muted-foreground">Oct 7, 2023</div>
                  <div className="text-sm text-muted-foreground">New Cafe Review</div>
                  <div className="text-sm text-muted-foreground">Lifestyle Blog</div>
                  <Link href="#" className="text-sm text-primary underline" prefetch={false}>
                    Read Review
                  </Link>
                </div>
