    ...
    <div className='flex h-screen w-full x-full'>
      <div className='flex-1 flex overflow-hidden bg-[#171717] relative justify-center items-center z-10'>
        ...
        <div className='flex flex-col mx-auto gap-2 px-4 xl:ml-40 mr-40 text-center md:text-start '>
          <h1 className="text-2xl font-bold leading-snug md:text-5xl text-[#fc0036] pt-3 text-balance">The Ultimate Newsletter Archive</h1>
          <p className="mt-3 mb-3 text-2xl leading-snug text-balance font-thin text-white dark:text-white lg:w-4/5"> 
            Discover and celebrate the art and creativity of newsletters. <br />We preserve stunning designs and captivating content, ensuring they are never lost in your inbox. Explore our archive and enjoy the best newsletters, all in one place.
          </p>
          <AuthButtons />
        </div>
      </div>
      ...
      <div className="flex-1 relative overflow-hidden justify-center items-center hidden md:flex">
        <Image
          ...
          fill
          className="object-cover opacity-90 pointer-events-none select-none height-full object-top"
        />
      </div>
    </div>
  );
